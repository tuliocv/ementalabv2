...
def _draw_static_graph(pairs):
    ...
    nx.draw_networkx_edges(G, pos, arrowstyle="->", arrowsize=24, edge_color="#0d6efd", width=2, alpha=0.8)
    nx.draw_networkx_labels(G, pos, font_size=5, font_weight="bold", font_color="#1c1c1c")
